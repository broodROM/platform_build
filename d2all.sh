...
# d2vzw
lunch oct_d2vzw-userdebug && make installclean && make otapackage -j$1
...
# d2spr
lunch oct_d2spr-userdebug && make installclean && make otapackage -j$1
find out/target/product '(' -name '*ota-eng*.zip' -size +100000k ')' -print0 |
        xargs --null md5sum |
        while read CHECKSUM FILENAME
        do
...
# d2usc
lunch oct_d2usc-userdebug && make installclean && make otapackage -j$1
find out/target/product '(' -name '*ota-eng*.zip' -size +100000k ')' -print0 |
        xargs --null md5sum |
        while read CHECKSUM FILENAME
        do
...
# d2att
lunch oct_d2att-userdebug && make installclean && make otapackage -j$1
find out/target/product '(' -name '*ota-eng*.zip' -size +100000k ')' -print0 |
        xargs --null md5sum |
        while read CHECKSUM FILENAME
        do
...
# d2cri
lunch oct_d2cri-userdebug && make installclean && make otapackage -j$1
find out/target/product '(' -name '*ota-eng*.zip' -size +100000k ')' -print0 |
        xargs --null md5sum |
        while read CHECKSUM FILENAME
        do
...
# d2tmo
lunch oct_d2tmo-userdebug && make installclean && make otapackage -j$1
find out/target/product '(' -name '*ota-eng*.zip' -size +100000k ')' -print0 |
        xargs --null md5sum |
        while read CHECKSUM FILENAME
        do
...
# d2mtr
lunch oct_d2mtr-userdebug && make installclean && make otapackage -j$1
find out/target/product '(' -name '*ota-eng*.zip' -size +100000k ')' -print0 |
        xargs --null md5sum |
        while read CHECKSUM FILENAME
        do
